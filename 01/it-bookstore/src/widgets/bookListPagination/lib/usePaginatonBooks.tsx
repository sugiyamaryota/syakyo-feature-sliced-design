...
interface UsePaginationBooksResults {
...
export const usePaginationBooks = (
    ...
    const getData = (newPage: number): void => {
        const isAccessiblePage = Math.ceil(totalCountBooks / NUMBER_OF_RETURNED_API_ELEMENTS) >= newPage * 2
